...
const HomepageEnding = () => {
    return (
        <div className="text-center py-20 bg-black text-white">
            ...
            <a
                href="https://hey-bunny-divyyams-projects.vercel.app"
            ...
            <section className="py-10">
                ...
                <div className="flex justify-center gap-6">
                    <a href="https://www.linkedin.com/in/divyameena/?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300">
                        <FaLinkedin className="text-2xl" />
                    </a>
                    <a href="https://www.instagram.com/divyaa_1007?igsh=M3h2ZW9rcHY0ejRz" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300">
            ...
            <footer className="py-4 bg-gray-800">
                <p className="text-sm">🚀💡 Ideas Launched by Divya</p>
            </footer>
        </div>
    );
};
